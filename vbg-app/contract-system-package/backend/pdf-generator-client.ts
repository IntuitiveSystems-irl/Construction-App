...
PARTIES:
Contractor: Niko Selby, Veritas Building Group
...
Contractor:
Niko Selby, Veritas Building Group
...
export function generateContractPDF(contract: Contract): jsPDF {
  ...
  try {
    // Add logo
    const logoUrl = 'https://roosterconstruction.org/wp-content/uploads/2025/04/cropped-Black-and-Blue-Flat-Illustrative-House-Repair-Service-Logo.webp';
  ...
  pdf.text('ROOSTER CONSTRUCTION LLC', pageWidth / 2, yPosition, { align: 'center' });
  yPosition += 15;
