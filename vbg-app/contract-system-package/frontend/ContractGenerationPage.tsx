            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex space-x-2">
                <button 
                  ...
                  className={`px-3 py-1 text-sm rounded ${userTypeFilter === 'all' ? 'bg-primary-500 text-white' : 'bg-gray-100 text-gray-700'}`}
                >
                  All
                </button>
                <button 
                  ...
                  className={`px-3 py-1 text-sm rounded ${userTypeFilter === 'client' ? 'bg-primary-500 text-white' : 'bg-gray-100 text-gray-700'}`}
                >
                  Clients
                </button>
                <button 
                  ...
                  className={`px-3 py-1 text-sm rounded ${userTypeFilter === 'subcontractor' ? 'bg-primary-500 text-white' : 'bg-gray-100 text-gray-700'}`}
                >
                  Subcontractors
                </button>
              </div>
