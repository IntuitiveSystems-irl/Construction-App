...
// Contract interface (for documentation)
// {
//   id: string;
//   contract_id?: string;
//   project_name: string;
...
const isContractContentCorrupted = (content) => {
...
const generateFullContractTemplate = (contract) => {
...
Contractor's License: VERIBBL788KM`;
};
...
export {
  generateContractPDF,
  isContractContentCorrupted,
  generateFullContractTemplate
};
