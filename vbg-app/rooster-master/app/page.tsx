...
export default function Home() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-500 via-red-500 to-yellow-500 flex items-center justify-center">
        <div className="text-center text-white">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-white mx-auto mb-4"></div>
          <p className="text-lg font-medium">Loading Rooster Construction...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pt-32 pb-32 sm:pt-48 lg:pt-56 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-8 text-xl leading-8 text-gray-600 max-w-3xl mx-auto">
              At Rooster, we turn ideas into reality with unmatched craftsmanship, integrity, and attention to detail.
            </p>
            <div className="mt-12 flex items-center justify-center gap-6 flex-wrap">
              <Link
                href="/register"
                className="group relative px-8 py-4 overflow-hidden rounded-xl bg-gradient-to-r from-gray-900 to-gray-700 text-white font-semibold shadow-lg hover:shadow-xl transform transition-all duration-200 hover:-translate-y-0.5 hover:shadow-gray-900/20"
              >
              ...
              <Link 
                href="/login" 
                className="px-6 py-4 text-gray-600 hover:text-gray-900 font-medium group transition-colors duration-200 border-b-2 border-transparent hover:border-gray-900"
              >
                Sign In 
      ...
      <div className="relative py-24 sm:py-32 bg-gradient-to-b from-black/50 to-gray-900/80 backdrop-blur-sm">
        <div className="absolute inset-0 -z-10 bg-[url('https://images.unsplash.com/photo-1600585154340-be6161a56a0c')] bg-cover bg-center opacity-10"></div>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl lg:text-center">
            <span className="text-sm font-semibold leading-7 text-amber-400">WHAT WE DO</span>
            <h2 className="mt-2 text-4xl font-bold tracking-tight text-white sm:text-5xl">
              Comprehensive Services with a <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-red-500">Personal Touch</span>
            </h2>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-2">
              <div className="relative group bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300">
                <div className="flex items-center mb-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-amber-400/20 group-hover:bg-amber-400/30 transition-colors">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
              Join hundreds of satisfied clients who trust Rooster Construction for their most important projects.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link
                href="/register"
                className="rounded-xl bg-gradient-to-r from-amber-500 to-orange-600 px-8 py-4 text-sm font-semibold text-white shadow-lg hover:from-amber-400 hover:to-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-600 transition-all duration-200 hover:scale-105"
              >
                Get Started Today
              </Link>
              <Link 
                href="/login" 
                className="text-sm font-semibold leading-6 text-white hover:text-amber-400 transition-colors duration-200"
              >
