...
import { ArrowLeft, Mail, Building, User, Send } from 'lucide-react';
...
export default function InviteClient() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/admin/invite-client`, {
        method: 'POST',
        headers: {
  ...
  if (success) {
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        <div className={`bg-gradient-to-r ${isEmailMethod ? 'from-green-600 via-blue-600 to-purple-600' : 'from-orange-600 via-red-600 to-yellow-600'} text-white`}>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`${isEmailMethod ? 'text-green-100' : 'text-orange-100'} mt-2`}>
                  Client invitation for {invitationResult?.email || formData.email}
                </p>
              </div>
            </div>
          </div>
            ...
            {isEmailMethod ? (
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">
                  ...
                  They will receive instructions on how to create their client account and get started.
                </p>
              </div>
            ) : (
              // Manual Method
              <div>
                <div className="text-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">Email Service Unavailable</h2>
                ...
                {invitationResult?.manualText && (
                  <div className="bg-gray-50 border rounded-lg p-4 mb-6">
                    <h3 className="font-semibold text-gray-900 mb-2">Copy and send this invitation:</h3>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-orange-600 via-red-600 to-yellow-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-between">
            <div>
              <button
              ...
              <p className="text-orange-100 mt-2">
                Send an invitation to a new client to join your construction management platform
              </p>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4">
              <button
                type="submit"
                disabled={loading}
                className="flex-1 bg-orange-600 text-white py-3 px-6 rounded-lg hover:bg-orange-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center"
              >
                {loading ? (
