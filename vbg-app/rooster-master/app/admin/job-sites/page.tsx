        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-3xl font-bold">Job Sites Management</h1>
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="bg-orange-700 text-white px-6 py-3 rounded-lg hover:bg-orange-800 transition-colors flex items-center font-semibold"
              >
              ...
              <button
                ...
                className="bg-white text-orange-600 px-6 py-3 rounded-lg hover:bg-orange-50 transition-colors flex items-center font-semibold"
              >
...
// Create Job Site Modal Component
