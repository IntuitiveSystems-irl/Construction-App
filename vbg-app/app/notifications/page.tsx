...
export default function NotificationPreferencesPage() {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setPreferences({
          ...
          contract_notifications: data.contract_notifications === 1 || data.contract_notifications === true,
          estimate_notifications: data.estimate_notifications === 1 || data.estimate_notifications === true,
          invoice_notifications: data.invoice_notifications === 1 || data.invoice_notifications === true,
          document_notifications: data.document_notifications === 1 || data.document_notifications === true
        });
      }
    } catch (error) {
  ...
  const notificationTypes = [
    ...
    {
      key: 'contract_notifications' as keyof NotificationPreferences,
      title: 'Contract Notifications',
      description: 'New contracts and contract updates',
      icon: <FileText className="h-5 w-5" />,
      color: 'text-blue-500'
    },
    {
      key: 'estimate_notifications' as keyof NotificationPreferences,
      title: 'Estimate Notifications',
      description: 'New estimates and estimate updates',
      icon: <DollarSign className="h-5 w-5" />,
      color: 'text-emerald-500'
    },
    {
      key: 'invoice_notifications' as keyof NotificationPreferences,
      title: 'Invoice Notifications',
      description: 'New invoices and payment updates',
      icon: <Receipt className="h-5 w-5" />,
      color: 'text-amber-500'
    },
    {
      key: 'document_notifications' as keyof NotificationPreferences,
      title: 'Document Notifications',
      description: 'Document uploads and update requests',
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-teal-100 mt-2">Manage your email notification settings</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                  ...
                  <div className="flex items-center ml-4">
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 ${
                        preferences[type.key] ? 'bg-teal-600' : 'bg-gray-200'
                      }`}
                    >
                      <span
        ...
        <div className="mt-6 bg-cyan-50 border border-cyan-200 rounded-lg p-6">
          <div className="flex items-start">
            <Mail className="h-6 w-6 text-cyan-500 mr-3 mt-0.5" />
            <div>
              <h3 className="text-lg font-medium text-cyan-900">About Email Notifications</h3>
