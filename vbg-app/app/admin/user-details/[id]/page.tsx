...
export default function UserDetailsPage() {
  ...
  const downloadContract = (contract: Contract) => {
    try {
      ...
      // Download the PDF
      pdf.save(`VBG_Construction_Contract_${contract.id}.pdf`);
  ...
  const handleEditUser = () => {
    console.log('Edit User button clicked', { userDetails, isEditing });
    setIsEditing(true);
    setEditForm({
      name: userDetails?.name || '',
      email: userDetails?.email || '',
  ...
  const getStatusBadge = (status: string) => {
    const statusConfig = {
      ...
      pending: { color: 'bg-primary-100 text-primary-800', icon: Clock },
      archived: { color: 'bg-gray-100 text-gray-800', icon: FileText },
      signed: { color: 'bg-cyan-100 text-cyan-800', icon: CheckCircle },
    };
  ...
  const getExpirationStatus = (expiresAt?: string) => {
    ...
    if (daysUntilExpiry < 0) {
      ...
      return { status: 'expiring', color: 'text-primary-600', text: `Expires in ${daysUntilExpiry} days` };
    }
      ...
      <div className="bg-gradient-to-r from-cyan-600 to-teal-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
              ...
              {!isEditing && (
                <>
                  ...
                  <button
                    ...
                    className="bg-white text-cyan-600 px-4 py-2 rounded-lg hover:bg-cyan-50 transition-colors flex items-center"
                  >
          ...
          <div className="mt-4">
            ...
            <p className="text-cyan-100">{userDetails?.company_name || 'Individual Contractor'}</p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
                  ...
                  {isEditing && (
                    <div className="flex items-center space-x-3">
                      ...
                      <button
                        ...
                        disabled={saveLoading}
                        className="px-4 py-2 bg-cyan-600 text-white rounded-lg hover:bg-cyan-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center"
                      >
                        {saveLoading ? (
                          <>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700">{userDetails.company_name || 'Not provided'}</p>
                        </div>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700">{userDetails.contact_name || userDetails.name}</p>
                        </div>
                      </div>
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700">{userDetails.phone || 'Not provided'}</p>
                        </div>
                      </div>
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700">{new Date(userDetails.created_at).toLocaleDateString()}</p>
                        </div>
                      </div>
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className={`font-medium ${
                            userDetails.is_verified ? 'text-green-600' : 'text-primary-600'
                          }`}>
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex-1">
                                <div className="flex items-center space-x-3">
                                  ...
                                  <div>
                                    <p className="font-medium text-gray-700">{doc.document_name || doc.original_name || 'Unnamed Document'}</p>
            ...
            {activeTab === 'contracts' && (
              <div className="bg-white rounded-lg shadow">
                <div className="px-6 py-4 border-b flex items-center justify-between">
                  <h2 className="text-xl font-semibold text-gray-700">Contracts</h2>
                  <button
                    onClick={() => router.push(`/generate-contract?user_id=${userId}`)}
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex-1">
                              <div className="flex items-center space-x-3">
                                ...
                                <div>
                                  <p className="font-medium text-gray-700">{contract.project_name}</p>
                                  ...
                                  {contract.user_name && (
                                    <p className="text-sm text-cyan-600 font-medium mt-1">
                                      📧 Sent to: {contract.user_name} ({contract.user_email})
                                    </p>
                                  )}
                                </div>
                              </div>
            ...
            {activeTab === 'jobsites' && (
              <div className="bg-white rounded-lg shadow">
                <div className="px-6 py-4 border-b">
                  <h2 className="text-xl font-semibold text-gray-700">Job Site Assignments</h2>
                </div>
                <div className="p-6">
                  {contracts.filter(c => c.contract_type === 'job_site').length === 0 ? (
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex-1">
                              <div className="flex items-center space-x-3">
                                ...
                                <div>
                                  <p className="font-medium text-gray-700">{jobAssignment.project_name}</p>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-sm px-2 py-1 rounded ${userDetails.is_verified ? 'bg-green-100 text-green-800' : 'bg-primary-100 text-primary-800'}`}>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b px-6 py-4 flex items-center justify-between">
              <h2 className="text-xl font-semibold text-gray-700">Contract Details</h2>
              <button
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-gray-700">{selectedContract.project_name}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-500">Start Date</p>
                    <p className="text-gray-700">{new Date(selectedContract.start_date).toLocaleDateString()}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-500">End Date</p>
                    <p className="text-gray-700">{new Date(selectedContract.end_date).toLocaleDateString()}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-500">Total Amount</p>
                    <p className="text-gray-700">${selectedContract.total_amount.toLocaleString()}</p>
                  </div>
                </div>
              </div>
              ...
              {/* Project Description */}
              <div>
                <h3 className="text-lg font-medium text-gray-700 mb-2">Project Description</h3>
              ...
              {selectedContract.user_comments && (
                <div>
                  <h3 className="text-lg font-medium text-gray-700 mb-2">User Comments</h3>
              ...
              {/* Creation Info */}
              <div>
                <h3 className="text-lg font-medium text-gray-700 mb-2">Contract Information</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm font-medium text-gray-500">Contract ID</p>
                    <p className="text-gray-700 font-mono text-sm">{selectedContract.id}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-500">Created</p>
                    <p className="text-gray-700">{new Date(selectedContract.created_at).toLocaleDateString()}</p>
                  </div>
                  <div>
                  ...
                  {selectedContract.signed_at && (
                    <div>
                      ...
                      <p className="text-gray-700">{new Date(selectedContract.signed_at).toLocaleDateString()}</p>
                    </div>
                  )}
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                disabled={deleteUserLoading}
                className="bg-white text-cyan-600 px-4 py-2 rounded-lg hover:bg-cyan-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
              >
                {deleteUserLoading ? (
                  <>
