...
export default function AdminRegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validation
    if (!name.trim() || !email.trim() || !password.trim() || !adminKey.trim()) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-primary-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-orange-500 via-red-500 to-primary-500 text-white py-6 shadow-lg">
        ...
        <div className="max-w-md w-full space-y-8">
          <div className="bg-white rounded-xl shadow-xl p-8">
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-gray-700">Create Admin Account</h2>
              <p className="mt-2 text-sm text-gray-600">
                Register as an administrator for VBG Management
              </p>
            </div>
