          ...
          <div className="flex items-center justify-between">
            <div>
              <button
                ...
                className="flex items-center text-gray-900 hover:text-gray-700 text-sm font-normal tracking-wide transition-colors mb-4"
              >
                <ArrowLeft className="h-5 w-5 mr-2" />
                Back to Admin Dashboard
              </button>
              <h1 className="text-2xl font-bold tracking-wide text-gray-900 mb-2">Job Sites Management</h1>
              <p className="text-gray-800 text-sm font-normal tracking-wide mt-2">
            ...
            <div className="flex space-x-3">
              ...
              >
                ...
                <span className="bg-gradient-to-r from-teal-500 to-cyan-600 bg-clip-text text-transparent">Create Job Site</span>
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {jobSites.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No Job Sites Yet</h3>
              ...
              <div key={jobSite.id} className="bg-white rounded-lg shadow-lg overflow-hidden">
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-1">{jobSite.name}</h3>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-lg w-full">
            <div className="p-6 border-b">
              <h2 className="text-xl font-bold text-gray-900">Send Message to {selectedJobSite.name}</h2>
            </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex items-center">
                ...
                />
                <label htmlFor="send_sms" className="ml-2 block text-sm text-gray-900">
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b">
          <h2 className="text-xl font-bold text-gray-900">Create New Job Site</h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="flex justify-end space-x-4 pt-6 border-t">
            ...
            >
              {loading ? 'Creating...' : '<span className="bg-gradient-to-r from-teal-500 to-cyan-600 bg-clip-text text-transparent">Create Job Site</span>'}
            </button>
          </div>
        </form>
      </div>
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-2xl w-full max-h-[80vh] overflow-y-auto">
        <div className="p-6 border-b">
          <h2 className="text-xl font-bold text-gray-900">Assign Users to {jobSite.name}</h2>
        </div>
